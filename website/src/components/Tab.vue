...
<template>
    <div class="tab-container">
        ...
        <div class="services-tab" v-if="activeTab === 'services'">
            ...
            <Card class="card" ServiceName="Photo Lens" ServiceImage="/images/service-1.jpg"
...
" ServiceStatus="Discountinued" ServiceRevenue="10" ServiceLink="https://example.com" />
            <Card ServiceName="Macbook Clean" ServiceImage="/images/service-2.jpg" ServiceStartYear="2021"
...
" ServiceStatus="Growing" ServiceRevenue="1200" ServiceLink="https://example.com" />
            <Card ServiceName="Money Report" ServiceImage="/images/service-3.jpg" ServiceStartYear="2023"
...
" ServiceStatus="Sold" ServiceRevenue="25000" ServiceLink="https://example.com" />
        ...
        <div v-if="activeTab === 'links'">
            <div class="links-tab">
                <Link LinkName="Substack" LinkImage="/images/newsletter.jpg"
                    LinkDescription="My montly Newsletter" LinkText="Read More" LinkURL="https://substack.com" />
                <Link LinkName="Portfolio" LinkImage="/images/portfolio.jpg" LinkDescription="My Portfolio"
